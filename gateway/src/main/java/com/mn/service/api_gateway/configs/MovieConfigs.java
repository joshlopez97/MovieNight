package com.mn.service.api_gateway.configs;

import com.mn.service.api_gateway.logger.ServiceLogger;

import static com.mn.service.api_gateway.GatewayService.ANSI_RED;
import static com.mn.service.api_gateway.GatewayService.ANSI_RESET;
...
public class MovieConfigs {
    ...
    public String getEPStarDetailedGet() {
        return "/star/get/{id}";
    }
