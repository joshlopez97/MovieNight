...
import static com.mn.service.api_gateway.GatewayService.*;
...
public class GatewayConfigs {
    ...
    public GatewayConfigs(ConfigsModel cm) throws NullPointerException {
        if (cm == null) {
            ...
            if (numThreads <= 0) {
                numThreads = 3;
                System.err.println(ANSI_RED + "numThreads not found in configuration file. Using default." + ANSI_RESET);
            } else {
